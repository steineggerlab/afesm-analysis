...
@click.command()
@click.option('--input_file', type=click.Path(exists=True), default='final_set_vs_TED_novel', help="Input file containing alignment lines.")
@click.option('--output_pass', type=click.Path(), default='tednewfolds_match.m8', help="Output file for lines that pass the filtering criteria.")
@click.option('--output_fail', type=click.Path(), default='tednewfolds_nomatch.m8', help="Output file for lines that do not pass the filtering criteria.")
