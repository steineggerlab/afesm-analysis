...
# This converts e.g. [merizo.out, chainsaw.out, unidoc.out, crh.out] -> png
...
def main():
    ...
    parser.add_argument("-o", "--output_dir", type=str, required=True, help="Give directory to save images to.")
