...
@click.command()
@click.option('--input_file', type=click.Path(exists=True), default='n_hits_good_models_vs_CATH_s95.m8', help="Input file containing alignment lines.")
@click.option('--output_pass', type=click.Path(), default='cath_N_s95_match.m8', help="Output file for lines that pass the filtering criteria.")
@click.option('--output_fail', type=click.Path(), default='cath_N_s95_nomatch.m8', help="Output file for lines that do not pass the filtering criteria.")
